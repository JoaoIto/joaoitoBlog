...
export default function AdminForms() {
  ...
  return (
    ...
    <Card className="sm:w-3/4 lg:w-1/2 m-4 bg-card text-card-foreground shadow-md shadow-slate-400">
      <CardHeader>
      ...
      <CardContent>
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="article">
            <form
              onSubmit={articleForm.handleSubmit(onArticleSubmit)}
              className="space-y-2"
            >
              <div className="flex justify-between space-x-2">
                <div className="space-y-2 w-1/2">
                  ...
                  <Input
                    id="article-nome"
                    {...articleForm.register("nome")}
                    className="bg-input text-foreground"
                  />
                  {articleForm.formState.errors.nome && (
                    <p className="text-sm text-accent">
                      {articleForm.formState.errors.nome.message}
                    </p>
                  )}
                </div>
                <div className="space-y-2 w-1/2">
                  ...
                  <Input
                    id="article-areaEstudo"
                    {...articleForm.register("areaEstudo")}
                    className="bg-input text-foreground"
                  />
                  {articleForm.formState.errors.areaEstudo && (
                    <p className="text-sm text-accent">
                      {articleForm.formState.errors.areaEstudo.message}
                    </p>
                  )}
                </div>
              </div>
              <div className="space-y-2">
                ...
                <Textarea
                  id="article-descricao"
                  {...articleForm.register("descricao")}
                  className="bg-input text-foreground"
                />
                {articleForm.formState.errors.descricao && (
                  <p className="text-sm text-accent">
                    {articleForm.formState.errors.descricao.message}
                  </p>
                )}
              </div>
              <div className="space-y-2">
                ...
                <Input
                  id="article-linkAcesso"
                  {...articleForm.register("linkAcesso")}
                  className="bg-input text-foreground"
                />
                {articleForm.formState.errors.linkAcesso && (
                  <p className="text-sm text-accent">
                    {articleForm.formState.errors.linkAcesso.message}
                  </p>
                )}
              </div>
              <div className="space-y-2">
                <Label htmlFor="article-dataPublicacao">
                  Data de Publicação
                </Label>
                <Input
                ...
                {articleForm.formState.errors.dataPublicacao && (
                  <p className="text-sm text-accent">
                    {articleForm.formState.errors.dataPublicacao.message}
                  </p>
                )}
              </div>
              <Button
          ...
          <TabsContent value="project">
            <form
              onSubmit={projetoForm.handleSubmit(onProjetoSubmit)}
              className="space-y-4"
            >
              <div className="w-full flex justify-between space-x-2">
                <div className="w-1/2 space-y-2">
                  ...
                  <Input
                    id="project-nome"
                    {...projetoForm.register("nome")}
                    className="bg-input text-foreground"
                  />
                  {projetoForm.formState.errors.nome && (
                    <p className="text-sm text-accent">
                      {projetoForm.formState.errors.nome.message}
                    </p>
                  )}
                </div>
                <div className="w-1/2 space-y-2">
                  <Label htmlFor="project-tecnologias">Tecnologias</Label>
                  <Input
                    id="project-tecnologias"
                    {...projetoForm.register("tecnologias")}
                    className="bg-input text-foreground"
                  />
                  {projetoForm.formState.errors.tecnologias && (
                    <p className="text-sm text-accent">
                      {projetoForm.formState.errors.tecnologias.message}
                    </p>
                  )}
                </div>
              </div>
              <div className="space-y-2">
                <Label htmlFor="project-linkGit">
                  Link do GitHub (opcional)
                </Label>
                <Input
                  id="project-linkGit"
                  {...projetoForm.register("linkGit")}
                  className="bg-input text-foreground"
                />
                {projetoForm.formState.errors.linkGit && (
                  <p className="text-sm text-accent">
                    {projetoForm.formState.errors.linkGit.message}
                  </p>
                )}
              </div>
              <div className="space-y-2">
                <Label htmlFor="project-linkAcesso">
                  Link de Acesso (opcional)
                </Label>
                <Input
                  id="project-linkAcesso"
                  {...projetoForm.register("linkAcesso")}
                  className="bg-input text-foreground"
                />
                {projetoForm.formState.errors.linkAcesso && (
                  <p className="text-sm text-accent">
                    {projetoForm.formState.errors.linkAcesso.message}
                  </p>
                )}
              </div>
              <div className="space-y-2">
                ...
                {projetoForm.formState.errors.dataCriacao && (
                  <p className="text-sm text-accent">
                    {projetoForm.formState.errors.dataCriacao.message}
                  </p>
                )}
              </div>
              <Button
